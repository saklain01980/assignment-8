        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-indigo-500 to-amber-400 flex items-center justify-center text-white font-bold text-lg">
                B
              </div>
              <span className="text-xl font-bold gradient-text">BookNest</span>
            </Link>
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-indigo-400 hover:border-indigo-500/30 hover:bg-indigo-500/10 transition-all duration-200"
                >
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="search-input !py-2 !text-sm flex-1"
                  id="footer-newsletter-input"
                />
                <button className="btn-primary-glow !py-2 !px-4 !text-sm" id="footer-newsletter-btn">
                  →
                </button>
              </div>
            </div>
